        ...
        <section className="hidden space-y-8 lg:block">
          ...
          <div className="space-y-4">
            <h1 className="max-w-xl text-5xl leading-tight font-semibold tracking-tight text-balance">
              Demo the entire buyer workflow without backend setup.
            </h1>
            <p className="max-w-xl text-base leading-relaxed text-slate-300">
              This build runs entirely on mock data. Browse the catalog, create purchase orders,
              edit drafts, and move statuses through the lifecycle in one session.
            </p>
          </div>
        </section>
